...
public class TextHolder extends JLabel implements FocusListener, DocumentListener {
	...
	public TextHolder(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public TextHolder(String text, JTextComponent component, Show show) {
